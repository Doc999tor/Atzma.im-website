        ...
        <div className='top-block'>
          ...
          <nav>
            {socialLinks.map(link => (
              <a key={link} href={link.url} target="_blank" title={link.url} ><img src={config.urls.media + link.icon} aria-label={config.translations.footer[link.name]} alt={config.translations.footer.social_networks[link.name]} /></a>
            ))}
          </nav>
        </div>
